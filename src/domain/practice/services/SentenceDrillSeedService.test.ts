...
describe('SentenceDrillSeedService', () => {
    ...
    it('should save all drills using the repository', async () => {
        ...
        const drills = [
            SentenceDrill.create({ id: '1', sentencePattern: 'SV', english: 'I run.', japanese: '私は走る。', sortOrder: 1 }),
            SentenceDrill.create({ id: '2', sentencePattern: 'SVO', english: 'I eat apple.', japanese: '私はリンゴを食べる。', sortOrder: 2 }),
        ];
