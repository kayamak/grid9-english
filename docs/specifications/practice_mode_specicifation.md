...
| 要素 | UI要素 | 操作 | 動作 | 備考 |
| :--- | :--- | :--- | :--- | :--- |
| **動詞** | `VerbSelector` (プルダウン) | プルダウンから動詞を選択する。 | 1. `verb` のPropsが選択された値に更新される。2. これに基づき、**9マスパネルの表示**が更新される。3. **対応する文章（英文の出だし）**が生成・表示される。 | **Do動詞の選択肢:** `live`, `go`, `arrive`, `talk`, `run`, `walk`, `smile`, `laugh` |
