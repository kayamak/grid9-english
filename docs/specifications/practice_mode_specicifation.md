...
| **Lv 6** | DO_SVC | ランダムに選んだ10問 | 30s - (Lv * 2) = 18秒 |
| **Lv 7** | DO_SV | ランダムに選んだ10問 | 30s - (Lv * 2) = 16秒 |
| **Lv 8** | DO_SVO | ランダムに選んだ10問 | 30s - (Lv * 2) = 14秒 |
| **Lv 9** | DO_SVC | ランダムに選んだ10問 | 30s - (Lv * 2) = 12秒 |

### 8.3 UI/UX の要件
- **トップ画面**: 「Free Practice」、「Sentence Drill」に加えて「Drill Quest」へのエントリーボタンを表示します。
- **進捗表示**: 現在のレベル、正解数、残り時間をリアルタイムに表示します。
- **演出**: レベルアップ時の達成感を高める視覚的・聴覚的フィードバック（任意）。
